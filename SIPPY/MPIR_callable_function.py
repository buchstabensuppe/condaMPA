...
from sindy import reaction_rate_alex
from sindy.reaction_rate_alex import reaction_rate
from sindy import Parameter_PDE_CH4
...
def MPI_reactor(seconds, u, steps, x0):
